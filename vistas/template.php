  ...
  <body>
    ...
    <nav class="navbar navbar-expand navbar-light bg-light">
        <div class="nav navbar-nav">
            <a class="nav-item nav-link active" href="#">Sistema Empleados MVC <span class="visually-hidden">(current)</span></a>
            ...
            <a class="nav-item nav-link" href="?controlador=paginas&accion=nosotros">Nosotros</a>
        </div>
    </nav>
